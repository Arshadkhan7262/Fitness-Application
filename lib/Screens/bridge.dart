...
class Bridge extends StatefulWidget {
  ...
  Bridge(this.imageurl13, this.name13);
    ...
    return Scaffold(
      body: SingleChildScrollView(
        child: SafeArea(
          child: Column(
            children: [
              Image.asset('${widget.imageurl13}',height: 200,width: double.infinity,),
              Text('${widget.name13}',style: TextStyle(fontSize: 20,color: Colors.black,fontWeight: FontWeight.bold)),
              Container(
                height: 100,
                width: 100,
